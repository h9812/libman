...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h1>Chào mừng đến với Hệ thống Quản lý Thư viện</h1>");
        out.println("<p>Đây là trang chủ của ứng dụng web Java.</p>");
        out.println("<p>Bạn có thể truy cập <a href='index.html'>trang index</a> hoặc <a href='index.jsp'>trang JSP</a>.</p>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
    }
